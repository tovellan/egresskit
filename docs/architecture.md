...
- `explanation.py` removes nondeterministic receipt evidence from decision explanations.
...
- `cli.py` exposes validation, lint, decision, explanation, test, schema, and fixture
  commands.
