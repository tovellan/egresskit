...
uv pip install --python "$temp_dir/venv/bin/python" dist/egresskit-0.5.3-py3-none-any.whl
...
uv pip install --python "$temp_dir/venv/bin/python" "dist/egresskit-0.5.3-py3-none-any.whl[httpx]"
